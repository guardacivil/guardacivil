<?php
// usuarios_sem_restricao.php - Versão sem restrições
session_start();

// Verificar se está logado (aceita qualquer tipo de login)
$is_logged = false;
...
$currentUser = [
    'id' => $_SESSION['usuario_id'] ?? $_SESSION['admin_id'] ?? 'N/A',
    'nome' => $_SESSION['usuario_nome'] ?? $_SESSION['admin_nome'] ?? 'Usuário',
    'perfil' => $_SESSION['usuario_perfil'] ?? $_SESSION['admin_perfil'] ?? 'Sem perfil',
    'is_admin' => isset($_SESSION['admin_logado']) && $_SESSION['admin_logado'] === true
];
...
<body class="bg-gray-100">
    ...
    <aside class="sidebar" style="width: 16rem; background-color: #1e40af; color: white; height: 100vh; padding: 1.25rem; position: fixed; top: 0; left: 0; overflow-y: auto; box-shadow: 2px 0 12px rgba(0,0,0,0.2); z-index: 30;">
        ...
        <nav>
            ...
            <a href="usuarios_sem_restricao.php" style="display: block; padding: 0.5rem 1rem; border-radius: 0.375rem; margin-bottom: 0.5rem; color: white; text-decoration: none; transition: background-color 0.3s ease; background-color: #2563eb;">Gestão de Usuários</a>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Versão Sem Restrições - Aceita qualquer login</p>
                </div>
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                <h3 class="font-semibold text-green-800 mb-2">
                    <i class="fas fa-check-circle mr-2"></i>Status da Sessão
                </h3>
                <div class="text-sm text-green-700">
                    <p><strong>Logado:</strong> ✅ Sim</p>
                    <p><strong>Tipo:</strong> <?= $currentUser['is_admin'] ? 'Administrador' : 'Usuário Normal' ?></p>
